    ...
    <table class="table table-striped table-bordered" >
        ...
        <s:iterator value="categories" var="Category" status="stu">
            <tr class="text-center">
                ...
                <td>
                    <%--<button class="btn btn-secondary"><s:a href="/New/category_updateCategory.action?id=%{#Category.id}">修改</s:a></button>--%>
                    <%--<button class="btn btn-danger"><s:a href="/New/category_deleteCategory.action?id=%{#Category.id}">删除</s:a></button>--%>
