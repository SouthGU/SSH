                ...
                <s:form action="news_findNewsByCategoryName" namespace="/" method="POST" name="listnew" >
                    ...
                    <div class="col">
                        <table class="table table-striped table-bordered">
                            ...
                            <s:iterator value="pageBean1.list" var="newsList" status="stu">
                                <tr align="center">
                            ...
                            <tr align="center">
                                <td colspan="5">
                                    ...
                                    <s:if test="pageBean1.page!=1">
                                        <a href="/New/news_findNewsByCategoryName.action?page=1&&category_id=<s:property value="cid"/>">首页</a>|
                                        <a href="/New/news_findNewsByCategoryName.action?page=<s:property value="pageBean1.page-1"/>&&category_id=<s:property value="cid"/>">上一页</a>|
                                    </s:if>
                                    <s:if test="pageBean1.page!=pageBean1.totalPage">
                                        <a href="/New/news_findNewsByCategoryName.action?page=<s:property value="pageBean1.page+1"/>&&category_id=<s:property value="cid"/>">下一页</a>|
                                        <a href="/New/news_findNewsByCategoryName.action?page=<s:property value="pageBean1.totalPage"/>&&category_id=<s:property value="cid"/>">尾页</a>
                                    </s:if>
                                </td>
                            <tr align="center">
                        </table>
